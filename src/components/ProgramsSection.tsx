              ...
              <div className="md:w-1/2">
                ...
                <Accordion type="single" collapsible className="bg-white rounded-lg shadow-sm border border-border">
                  ...
                  <AccordionItem value="year2">
                    <AccordionTrigger className="px-5 py-4 hover:no-underline hover:bg-muted/50">
                      <span className="font-semibold">Year 2: Business Planning & Finance</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-5 pb-4 pt-0">
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
                  ...
                  <AccordionItem value="year3">
                    <AccordionTrigger className="px-5 py-4 hover:no-underline hover:bg-muted/50">
                      <span className="font-semibold">Year 3: Advanced Entrepreneurship</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-5 pb-4 pt-0">
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
                  ...
                  <AccordionItem value="year4">
                    <AccordionTrigger className="px-5 py-4 hover:no-underline hover:bg-muted/50">
                      <span className="font-semibold">Year 4: Capstone & Certification</span>
                    </AccordionTrigger>
                    <AccordionContent className="px-5 pb-4 pt-0">
                      <ul className="space-y-2">
                        <li className="flex items-start gap-2">
