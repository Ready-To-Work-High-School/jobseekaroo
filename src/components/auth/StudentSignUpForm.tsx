      ...
      <div className="md:col-span-2">
        <Card>
          <CardContent className="p-6">
            <h2 className="text-xl font-semibold mb-4">Join Our Platform</h2>
            
            <div className="flex items-center gap-2 mb-4">
              <GraduationCap className="h-5 w-5 text-primary" />
              <span className="font-medium">Exclusive for Westside High School Students</span>
            </div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Personalized Job Recommendations</strong> based on your skills and interests</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                <span><strong>Career Development Tools</strong> to help you build professional skills</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                <span><strong>Interview Preparation</strong> resources and practice sessions</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                <span><strong>Saved Job Tracking</strong> to keep your opportunities organized</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle2 className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                <span><strong>Success Stories</strong> from other students who found employment</span>
              </li>
            </ul>
            
            <div className="mt-6 bg-blue-50 border border-blue-200 rounded-md p-3">
              <p className="text-sm text-blue-800">
                <strong>Get started today!</strong> Create your account to access all features of Job Seekers 4 High Schools and launch your career journey.
              </p>
            </div>
          </CardContent>
        </Card>
