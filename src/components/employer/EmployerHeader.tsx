      ...
      <div className="text-center mb-12">
        <div className="flex justify-center mb-4 relative">
          ...
          <div className="relative">
            ...
            <div className="absolute -inset-4 rounded-full bg-gradient-to-r from-blue-700 to-amber-400 opacity-30 blur-lg glow-pulse"></div>
            <div className="absolute -inset-5 rounded-full bg-gradient-to-r from-amber-500 to-blue-600 opacity-25 blur-xl"></div>
            <div className="absolute -inset-6 rounded-full bg-gradient-to-r from-blue-600 to-amber-500 opacity-20 blur-2xl"></div>
            <img 
