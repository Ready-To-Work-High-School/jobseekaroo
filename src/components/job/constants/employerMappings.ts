...
/**
 * Industry mappings for companies
 */
...
/**
 * Logo URL mappings for companies
 */
export const LOGO_MAP: Record<string, string> = {
  ...
  'CSX Transportation': '/lovable-uploads/2f5babe6-5aa1-4d84-936a-f459a5c19b6b.png', // Updated with new CSX logo
  'Florida Blue': '/lovable-uploads/73c2c288-a239-474f-bf32-fe55902e3cbd.png',
