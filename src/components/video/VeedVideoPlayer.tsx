...
const VeedVideoPlayer = ({ 
  ...
  thumbnailUrl = "/lovable-uploads/37c7b57e-b280-4ee0-abe9-5e3da84a418b.jpg", // Default thumbnail
    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0 bg-black/40 group-hover:bg-black/50 transition-all flex items-center justify-center rounded-lg">
          ...
          <div className="absolute bottom-4 left-4 px-3 py-1 bg-primary/90 text-white text-xs font-medium rounded-full flex items-center">
            <span className="mr-1">●</span> Interview Tips
          </div>
        </div>
      </div>
