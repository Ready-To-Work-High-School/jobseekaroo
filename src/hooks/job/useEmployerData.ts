...
import { Employer, EmployerDataResult } from '@/components/job/hooks/types';
import { enhanceEmployerData } from '@/components/job/utils/employerDataUtils';
import { getFallbackEmployerData } from '@/components/job/data/fallbackEmployerData';
