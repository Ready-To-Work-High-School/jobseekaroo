...
const Profile = () => {
  ...
  const { isCeo, isAdmin, isEmployer, showCeoIcon, accountAge, isInceptionMember } = useProfileStatus(userProfile);
  const { employerStats } = useEmployerStats(user, isEmployer);
